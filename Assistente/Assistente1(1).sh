...
while [  $aux != 0 ]; do
  	...
  	echo "----------------------------------------------------"
	echo "";
	echo "Insira o nome do programa";
	read aux;
	if [ $aux != 0 ]
	then
		echo "";
		apt-get install $valor;
	else
		echo "Saindo do pŕograma";
	fi
done
Menu
}
...
while [  $aux != 0 ]; do
  	...
  	echo "----------------------------------------------------"
	echo "";
	echo "Insira o nome do programa a ser removido";
	read aux;
	if [ $aux != 0 ]
	then
		echo "";
		apt-get purge -f $valor;
	else
		echo "Saindo do pŕograma";
	fi
done
...
cp ntp.date /etc/cron.hourly/
sleep 1
#---------------------------------------------------------------------------------#
echo "adicionando permição de execução"
chmod 777 /etc/cron.hourly/ntp.date
sleep 1
#---------------------------------------------------------------------------------#
}
...
then
	echo "apt não foi desconfado. voltando ao menu"
	sleep 2
	Menu
else
	echo "apt foi desconfado, saindo"
	sleep 1
	clear
	exit
fi
